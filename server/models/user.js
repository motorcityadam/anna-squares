...
module.exports = {
  ...
  twitterStrategy: function() {
    if(!config.twitter.consumerID)    throw new Error('A Twitter Consumer Key is required if you want to enable login via Twitter.');
    if(!config.twitter.consumerSecret) throw new Error('A Twitter Consumer Secret is required if you want to enable login via Twitter.');
  ...
  facebookStrategy: function() {
    if(!config.facebook.appID)     throw new Error('A Facebook App ID is required if you want to enable login via Facebook.');
    if(!config.facebook.appSecret) throw new Error('A Facebook App Secret is required if you want to enable login via Facebook.');
  ...
  linkedInStrategy: function() {
    if(!config.linkedin.consumerKey)     throw new Error('A LinkedIn App Key is required if you want to enable login via LinkedIn.');
    if(!config.linkedin.consumerSecret) throw new Error('A LinkedIn App Secret is required if you want to enable login via LinkedIn.');
