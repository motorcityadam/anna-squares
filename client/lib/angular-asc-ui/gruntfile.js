...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    meta: {
      modules: 'angular.module("asc.ui", [<%= srcModules %>]);',
      tplmodules: 'angular.module("asc.ui.tpls", [<%= tplModules %>]);',
      all: 'angular.module("asc.ui", ["asc.ui.tpls", <%= srcModules %>]);'
    },
    delta: {
      docs: {
    ...
    changelog: {
      options: {
        ...
        github: 'AlliedStrand/angular-asc-ui'
      }
    },
    shell: {
  ...
  //Common asc.ui module containing all modules for src and templates
  ...
  function findModule(name) {
    ...
    var module = {
      name: name,
      moduleName: enquote('asc.ui.' + name),
  ...
  function dependenciesForModule(name) {
    ...
    .forEach(function(contents) {
      ...
      dependencies.split(',').forEach(function(dep) {
        if (dep.indexOf('asc.ui.') > -1) {
          var depName = dep.trim().replace('asc.ui.','').replace(/['"]/g,'');
