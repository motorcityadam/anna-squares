...
describe('directives', function() {
  ...
  describe('accessLevel', function() {
    ...
    it('when user is public and access is public - the menu must be visible',
        inject(function($compile, $rootScope, accessLevels){
    ...
    it('when user is public and access is user - the menu must be hidden',
        inject(function($compile, $rootScope, accessLevels){
